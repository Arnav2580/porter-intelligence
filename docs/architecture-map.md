...
Mermaid AI / Mermaid Live visual source: [architecture-map.mmd](architecture-map.mmd). Use this file for the readable "control-room" architecture view; the detailed inventory remains in this Markdown file.
...
flowchart TB
  subgraph api["api/"]
    ...
    apiRegistry["router_registry.py\nsingle live router list"]
